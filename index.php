...
<html lang="en">
  <head>
    <title>Unisex Salon||Home Page</title>
  ...
  <body>
	...
	<section class="hero-wrap hero-wrap-2" style="background-image: url('images/mensmain.jpg');" data-stellar-background-ratio="0.5">
		<div class="overlay"></div>
		<div class="container">
		  <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
			<div class="col-md-9 ftco-animate pb-5">
			  <h2 class="mb-0 bread">Unisex Salon</h2>
			  <div class="text">
			  <h1 class="mb-4" style="color: white;">Barber Shop.</h1>
			  <p class="mb-4"  style="color: rgb(8, 8, 8);">For over two centuries, Truefitt & Hill, the world's oldest and one of the best luxury barbershop for men has been offering a wide range of services designed to groom gentlemen to perfection.</p>
		  </div>
			</div>
		  </div>
		</div>
    	...
    	<div class="container-fluid px-0">
    		<div class="row no-gutters d-md-flex justify-content-end">
              ...
              ?>
					...
					<div class="one-third">
						<div class="img" style="background-image: url(images/image_2.jpg);">
						</div>
					</div>
    		</div>
    	</div>
